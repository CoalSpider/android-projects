...
import com.ben.drawcontrolsprototype.renderer.ShaderHelper;
...
//						Toast.makeText(mLessonSevenActivity, "Out of memory; Dalvik takes a while to clean up the memory. Please try again.\nExternal bytes allocated=" + dalvik.system.VMRuntime.getRuntime().getExternalBytesAllocated(), Toast.LENGTH_LONG).show();								
	...
	//	GLES20.glEnable(GLES20.GL_DEPTH_TEST);
		...
		final String vertexShader = RawResourceReader.readTextFileFromRawResource(mLessonSevenActivity, R.raw.vertex_shader);
 		final String fragmentShader = RawResourceReader.readTextFileFromRawResource(mLessonSevenActivity, R.raw.fragment_shader);
		...
		// Load the texture
		mAndroidDataHandle = TextureHelper.loadTexture(mLessonSevenActivity, R.drawable.circle_test1);
	...
	{		
        ...
        Matrix.translateM(mModelMatrix, 0, 0.0f, 0.0f, -20.5f);
		Matrix.scaleM(mModelMatrix,0,5,5,5);
